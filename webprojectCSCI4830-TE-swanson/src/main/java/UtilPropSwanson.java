...
public class UtilPropSwanson {
   static final boolean _W = System.getProperty("os.name").toLowerCase().contains("windows");
   static String _PROP_FILENAME_WIN_LOCAL = "C:\\Users\\Jen14Owns\\workspace_CSCI4830_swanson\\workspaceCSCI4830-TE-swanson\\webprojectCSCI4830-TE-swanson\\src\\main\\webapp\\config.properties";
   static String _PROP_FILENAME_OSX_LOCAL = "/YOUR_PATH/webproject/WebContent/config.properties";
   // * Remote server path
   static String _PROP_FILENAME_REMOTE = "/var/lib/tomcat9/webapps/webprojectCSCI4830-TE-swanson/config.properties";
